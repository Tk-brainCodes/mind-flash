...
import { BarChart3, Edit, FileQuestion, PlusCircle, Repeat, LoaderCircle } from 'lucide-react';
          ...
          {flashcards.length === 0 ? (
            <div className='w-full h-56 col-span-12 flex items-center justify-center bg-white border-t-4 border-indigo-500 p-8 rounded-lg flex-col gap-5'>
              ...
              <p className='text-lg text-gray-600'>
                You don&apos;t have any flashcards yet. Generate some above!
              </p>
            </div>
          ) : (
              ...
              >
                ...
                >
                  {flipped[card.id || index.toString()] ? (
                    ...
                    <Card className='w-full  bg-white border-t-4 border-indigo-500 hover:shadow-lg transition-shadow duration-300 flex flex-col'>
                      <CardHeader className='bg-indigo-50'>
